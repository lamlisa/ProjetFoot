...
from module.strategy import DefenseurStrategy, Fonceur3Strategy


class ParamSearch(object):
    def __init__(self, strategy, params, simu=None, trials=50, max_steps=1000000,
                 max_round_step=300):
    ...
    def start(self, show=True):
        if not self.simu:
            ...
            team2.add(Fonceur3Strategy().name, Fonceur3Strategy())
    ...
    def begin_match(self, team1, team2, state):
        ...
        if len(self.params) > 6:
            raise ValueError('Max five parameters')
